...
agmip_farmclimate <- function(seedfile,shortregion,headerplus,sitelat,sitelon,refht,wndht,outend,rootDir,dataDir,datashort){
...
#     
  ...
  for (thissite in 2:length(sitelat)){
    ...
    outfile <- paste(rootDir, '/output/', shortregion, sitez, outend, '.AgMIP', sep='')
    cat(outfile,'\n')
