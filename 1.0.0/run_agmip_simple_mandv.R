...
headerplus  <- 'Mean and daily variability changes for Tmax, Tmin, and P'
...
###   21 = FGOALS-g2,     22 = CMCC-CM,       23 = CMCC-CMS,         24 = CNRM-CM5
###   25 = HadGEM2-AO,    26 = IPSL-CM5B-LR,  27 = GFDL-CM3,         28 = GISS-E2-R, '
###   29 = GISS-E2-H
run.gcms    <- as.numeric(unlist(strsplit(gcms,','))) #1:29
