...
agmip_farmclimate(seedfile,shortregion,headerplus,sitelat,sitelon,refht,wndht,outend,rootDir,dataDir,datashort)
...
rootDir<-args[1]#"/Users/weixiong/Development/face-it/RIA/AgMIP_Scenarios_Generator"
dataDir<-args[2]#"/Users/weixiong/Development/face-it/RIA/AgMIP_Scenarios_Generator"
seedfile<-args[3]#"KEMB0XXX"
shortregion<-args[4]#"MB"
headerplus<-args[5]
#args6<-"-00.70,-00.60,-00.75,-00.74"
#args7<-"37.54,37.58,37.69,38.54"
sitelat<-as.numeric(unlist(strsplit(args[6],split=",")))#
sitelon<-as.numeric(unlist(strsplit(args[7],split=",")))#
datashort<-args[8]#
